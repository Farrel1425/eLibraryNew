...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Buat kategori baru untuk mengorganisir koleksi buku perpustakaan</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form action="{{ route('petugas.kategori.store') }}" method="POST" id="categoryForm">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="position-relative">
                        <textarea name="deskripsi"
                                  ...
                                  rows="4"
                                  maxlength="255"
                                  placeholder="Masukkan deskripsi kategori untuk memberikan informasi lebih detail tentang jenis buku yang termasuk dalam kategori ini...">{{ old('deskripsi') }}</textarea>
                        <div class="form-text d-flex justify-content-between">
                            <small class="text-muted">
