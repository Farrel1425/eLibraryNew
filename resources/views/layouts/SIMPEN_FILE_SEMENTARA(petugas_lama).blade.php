                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a href="{{ route('petugas.peminjaman.index') }}" class="nav-link">
                                <i class="fas fa-arrow-up-right-from-square me-2"></i> Peminjaman
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('petugas.pengembalian.index') }}" class="nav-link">
                                <i class="fas fa-undo-alt me-2"></i> Pengembalian</a>
                        </li>
                         <li class="nav-item">
                            <a href="{{ route('petugas.kategori.index') }}" class="nav-link">
                                <i class="fas fa-undo-alt me-2"></i> Monitoring Kunjungan</a>
                        </li>
                    </ul>
                </div>
               ...
               <!-- Bagian Pengaturan (tetap di bawah) -->
                <div class="px-3 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                             <a href="{{ route('anggota.kunjungan.create') }}" target="_blank" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                                📥 Buka Form Input Kunjungan (Anggota)
                            </a>
                        </li>
                       <li class="nav-item">
